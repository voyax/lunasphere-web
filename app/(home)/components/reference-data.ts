...
export const references: Record<string, ReferenceData> = {
  'aap-fontanelles': {
    id: 'aap-fontanelles',
    source: {
      zh: 'American Family Physician - 后囟闭合时间',
  ...
  'who-fontanelles': {
    id: 'who-fontanelles',
    source: {
      zh: 'American Family Physician - 前囟闭合时间',
  ...
  'pediatrics-growth': {
    ...
    source: {
      zh: 'Scientific Reports - 婴儿大脑发育研究',
  ...
  'medical-plasticity': {
    ...
    source: {
      zh: 'Deutsches Ärzteblatt - 位置性头型畸形',
  ...
  'birth-recovery': {
    id: 'birth-recovery',
    source: {
      zh: 'Contemporary Pediatrics - 新生儿头型评估',

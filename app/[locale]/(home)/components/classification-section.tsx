  ...
  const headShapeVariations = [
    {
      ...
      imageSrc: '/images/head-examples/brachycephaly_top_view.png',
    },
    {
      type: 'plagiocephaly',
      ...
      category: 'positional',
      // Image configuration - provide image URL here
      imageSrc: '/images/head-examples/plagiocephaly_top_view.png',
    },
    {
      type: 'dolichocephaly',
      ...
      category: 'positional',
      // Image configuration - provide image URL here
      imageSrc: '/images/head-examples/dolichocephaly_top_view.png',
    },
    {
      type: 'scaphocephaly',
  ...
  return (
    ...
    >
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
              ...
              >
                <CardHeader className='p-0'>
                  <div className='w-full space-y-4'>
                    {/* Image container */}
                    <div className='relative w-full h-48  bg-white dark:from-gray-800 dark:to-gray-700 rounded-lg overflow-hidden'>
                      {/* Real images will be displayed when hasImage is true */}
                      <Image
                        fill
                      ...
                      {shape.sensitiveImage && (
                        <div className='absolute inset-0 bg-white/30 dark:bg-gray-900/30 backdrop-blur-xl'>
                          <div className='absolute inset-3 rounded-md border-2 border-dashed border-stone-200/60 dark:border-gray-600/40 flex flex-col items-center justify-center gap-1.5'>
                            <div className='w-9 h-9 rounded-full bg-rose-50 dark:bg-rose-950/30 border border-rose-100 dark:border-rose-900/50 flex items-center justify-center'>
                    ...
                    <div className='flex justify-center gap-2'>
                      <span
                        className={`px-3 py-1 rounded-full text-xs font-medium ${
                          shape.severity === 'common'
                            ? 'bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-300'
                            : shape.severity === 'moderate'
                ...
                <CardBody className='px-6 pb-6'>
                  <div className='space-y-4'>
                    <div className='space-y-3'>
                      ...
                      >
                        {t(`classification.${shape.type}.name`)}
                      </h3>
                    </div>
                      ...
                      <div className='bg-blue-50 p-3 rounded-lg border-l-4 border-blue-400 dark:bg-blue-950/20 dark:border-blue-500'>
                        <p className='text-sm text-default-600 leading-relaxed'>
                          <span className='font-semibold text-blue-800 dark:text-blue-300'>
                            {
                              t(
                                `classification.${shape.type}.description`
                              ).split('，')[0]
                            }
                            ，
                          </span>
                          {t(`classification.${shape.type}.description`)
                            .split('，')
                            .slice(1)
                            .join('，')}
                        </p>
                      ...
                      <div className='bg-green-50 p-3 rounded-lg border-l-4 border-green-400 dark:bg-green-950/20 dark:border-green-500'>
                        <p className='text-sm text-default-600 leading-relaxed'>
                          <span className='font-semibold text-green-800 dark:text-green-300'>
                            {
                              t(
                                `classification.${shape.type}.correction`
                              ).split('。')[0]
                            }
                            。
                          </span>
                          {t(`classification.${shape.type}.correction`)
                            .split('。')
                            .slice(1)
                            .join('。')}
                        </p>
        ...
        {/* Bottom reminders */}
        <SectionAnimations className='mt-16 space-y-6' delay={0.6}>
              ...
              <div className='flex items-start space-x-3'>
                ...
                <div className='text-left space-y-2'>
                  ...
                  <p className='text-sm md:text-base text-green-700 dark:text-green-400'>
                    ...
                    {t('classification.reminder_content')
                      .split('，')
                      .slice(1)
                      .join('，')}
                  </p>

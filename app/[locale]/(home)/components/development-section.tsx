...
export async function DevelopmentSection() {
  ...
  const developmentPoints: Array<{
    ...
    {
      title: t('development.structure.name'),
    ...
    {
      title: t('development.fontanelles.name'),
      description: (
        <>
    ...
    {
      title: t('development.growth.name'),
      description: (
        <>
          <ReferenceText
            locale={currentLocale}
    ...
    {
      title: t('development.plasticity.name'),
      description: (
        <>
          <ReferenceText
            locale={currentLocale}
    ...
    {
      title: t('development.birth.name'),
      description: (
        <>
          <ReferenceText
            locale={currentLocale}

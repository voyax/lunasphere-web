...
export async function HeadShapesSection() {
  ...
  const headShapeTypes = [
    {
      id: 'normal',
      title: t('classification.normal.name'),
    ...
    {
      id: 'brachycephaly',
      title: t('classification.brachycephaly.name'),
    ...
    {
      id: 'plagiocephaly',
      title: t('classification.plagiocephaly.name'),
    ...
    {
      id: 'dolichocephaly',
      title: t('classification.dolichocephaly.name'),
    ...
    {
      id: 'scaphocephaly',
      title: t('classification.scaphocephaly.name'),

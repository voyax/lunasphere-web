    ...
    return (
        <div className="w-full">
            ...
            <div className='text-center mb-16'>
                <h2 className='text-3xl md:text-4xl font-serif font-medium text-gray-900 dark:text-gray-100 mb-4'>
                    {t('title')}
                </h2>
            ...
            <div className="flex flex-col lg:flex-row gap-12 lg:gap-12 xl:gap-24 items-start">
                ...
                <div className="w-full lg:w-1/3 relative">
                    ...
                    <div className="flex lg:flex-col gap-4 overflow-x-auto lg:overflow-visible pb-4 lg:pb-0 px-4 lg:px-0">
                        {stages.map((stage) => {
                    ...
                    ${isActive ? 'bg-white dark:bg-gray-800 shadow-lg lg:shadow-none lg:bg-transparent' : 'hover:bg-gray-50 dark:hover:bg-gray-800/50'}
                  `}
                                >
                                    {/* Dot Indicator */}
                                    <div className={`
                    w-16 h-16 rounded-full flex items-center justify-center shrink-0 transition-all duration-500 z-10 border-4 border-white dark:border-gray-900
                    ${isActive ? `${stage.color} text-white scale-110 shadow-xl` : 'bg-gray-100 dark:bg-gray-800 text-gray-400 group-hover:bg-gray-200'}
                  `}>
                                        {stage.icon}
                                    </div>
                                    ...
                                    {/* Text */}
                                    <div>
                                        <span className={`block text-3xl font-serif font-medium transition-colors ${isActive ? 'text-gray-900 dark:text-gray-100' : 'text-gray-400'}`}>
                                            {stage.months}
                                        </span>
                    ...
                    {stages.map((stage) => {
                        ...
                        return (
                            <div
                                key={stage.id}
                                className={`
                            absolute top-0 left-0 w-full bg-white dark:bg-gray-800 rounded-3xl p-8 md:p-12 shadow-2xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-700
                        ...
                        `}
                            ...
                            >
                                <div className="flex items-center gap-4 mb-8">
                                    <div className={`px-4 py-1 rounded-full text-xs font-bold text-white uppercase tracking-wider ${stage.color}`}>
                                        Milestone
                                    </div>
                                ...
                                <div className="space-y-10">
                                    {/* Highlights Section */}
                                    <div>
                                        <h4 className="flex items-center gap-3 text-lg font-bold text-gray-900 dark:text-gray-100 mb-4">
                                            <Star className="w-5 h-5 text-amber-400 fill-current" />
                                            {t('highlightsLabel')}
                                        </h4>
                                        <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed pl-8 border-l-2 border-gray-100 dark:border-gray-700">
